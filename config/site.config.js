...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'ksky@hebine.onmicrosoft.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/njacknot/',
    },
    {
      name: 'Telegram',
      link: 'https://t.me/hebine',
    },
  ],
